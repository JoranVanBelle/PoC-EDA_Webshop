...
@Component
public class PaymentProducerComponent {
	
	private final ProducerProperties properties;
	
	public PaymentProducerComponent(ProducerProperties properties) {
		this.properties = properties;
	}
	
    @Bean
    public ProducerFactory<String, PaymentRegistered> paymentProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PaymentRegistered> paymentKafkaTemplate() {
