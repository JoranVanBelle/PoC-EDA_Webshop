...
@Component
public class PricingProducerComponent {
	
	private final ProducerProperties properties;
	
	public PricingProducerComponent(ProducerProperties properties) {
		this.properties = properties;
	}
	
    @Bean
    public ProducerFactory<String, PricingUpserted> pricingProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PricingUpserted> pricingKafkaTemplate() {
