...
@Component
public class InventoryProducerComponent {
	
	private final ProducerProperties properties;
	
	public InventoryProducerComponent(ProducerProperties properties) {
    ...
    @Bean
    public KafkaTemplate<String, InventoryUpserted> inventoryKafkaTemplate() {
